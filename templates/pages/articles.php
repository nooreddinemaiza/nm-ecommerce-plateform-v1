    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <span class="breadcrumb"><a href="/">Acceuil</a> > Actualités</span>
            </div>
        </div>
    </div>
</div>
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-12 col-lg-8">
            ...
            <div class="row mb-4 mt-4 page-description">
                <?php
                if (!empty($search)) {
                    echo '<h5>Résultats de recherche pour : 
                    "<strong style="color: #ee626b;">' . htmlspecialchars($search) . '</strong>"
                     <small class="text-muted">page: ' . $currentPage . ' sur ' . $totalPages . '</small></h5>';
                } else {
                    echo '<p>Découvrez nos dernières actualités et conseils</p>';
                }
                ?>
            </div>
            <div>
                            ...
                            <div class="col-12 mt-5">
                                <div class="card h-100 shadow-sm hover-shadow transition">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text"> <?= StringUtils::excerpt(text: $excerpt, length: 210); ?> </p>
                ...
                <?php
                    ...
                    echo '<div class="alert alert-info">Aucun article trouvé.</div>';
                }
                ?>
            </div>
